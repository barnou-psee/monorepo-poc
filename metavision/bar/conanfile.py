...
class MetavisionBar(ConanFile):
    ...
    def set_version(self):
        ...
        self.version = re.search(r"project\(metavision-bar VERSION (.*) LANGUAGES CXX\)", content).group(1)
    ...
    def package_info(self):
        ...
        self.cpp_info.components["bar"].libs = ["metavision_bar"]
        self.cpp_info.components["bar"].includedirs = ["cpp/include"]
        self.cpp_info.components["bar"].set_property("cmake_target_name", "Metavision::bar")
